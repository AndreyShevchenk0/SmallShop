# Generated by Django 3.0.8 on 2021-01-30 22:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_price', models.DecimalField(decimal_places=2, default=0, max_digits=9, verbose_name='загальна вартість')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sd_volume_max', models.CharField(blank=True, max_length=255, null=True, verbose_name='максимальная вбудована память')),
        ...
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(related_name='related_customer', to='app.Order', verbose_name='Замовлення покупця'),
        ),
        migrations.AddField(
            model_name='customer',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_price', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='загальна вартість')),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Customer', verbose_name='покупець')),
            ],
        ),
        migrations.AddField(
            model_name='cart',
            name='owner',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Customer', verbose_name='власник'),
        ),
        migrations.AddField(
            model_name='cart',
            name='products',
            field=models.ManyToManyField(blank=True, related_name='related_car', to='app.CartProduct'),
        ),
    ]
